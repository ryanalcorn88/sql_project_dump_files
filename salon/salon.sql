...
INSERT INTO public.appointments VALUES (27, 24, 1, '10:00');
...
INSERT INTO public.customers VALUES (24, 'Bob', '555-5555');
...
--
-- Name: appointments servfk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT servfk FOREIGN KEY (service_id) REFERENCES public.services(service_id);
