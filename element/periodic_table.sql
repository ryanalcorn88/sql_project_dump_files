...
--
-- Name: elements uniname; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements unisym; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unisym UNIQUE (symbol);


--
-- Name: properties fkato; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkato FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
